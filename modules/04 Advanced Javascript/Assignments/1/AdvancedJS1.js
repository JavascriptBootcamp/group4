...
//group4/Modules/01 JavaScript Programming/Assignments/27
function Validator() {
...
//group4/Modules/01 JavaScript Programming/Assignments/28

function BankAccount(accountNumber, ownerAccount){

    var balance = 0;
    BankAccount.prototype.accountNumber = accountNumber;
    BankAccount.prototype.ownerAccount = ownerAccount;
...
//group4/Modules/01 JavaScript Programming/Assignments/29
function Video(title, uploader, seconds){
    Video.prototype.title = title;
    Video.prototype.uploader = uploader;
    Video.prototype.seconds = seconds;
