...
export class ThumbnailsComponent  {
  @Output() outPic = new EventEmitter<string>();
  picArr: string[];
  constructor() { 
    this.picArr = [
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqsw9q1gKQhk3M3krgRtn9vCgYaKDvQD_GgJdL-y-jNiJRLbgC",
  ...
  emitPic(e){
    //console.log("in tumbnail",e.srcElement.currentSrc);
    this.outPic.emit(e.srcElement.currentSrc);
  }
